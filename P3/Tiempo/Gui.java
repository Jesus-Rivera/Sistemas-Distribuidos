...
public class Gui extends JFrame implements ActionListener {
    ...
    public JLabel horas[] = new JLabel[4];             // Etiqueta editable
    ...
    **/
    ...
    {       
        ...
        if(e.getSource() == boton[7])
        {
            ...
            System.out.println("Este reloj es id: "+this.reloj);
            if(this.reloj == 0)
            {
                System.out.println("ESTO NO DEBERIA: "+this.reloj);
            ...
            this.servidor.actualizador.enviarReloj(this.reloj-1,caja[0].getText()+":"+caja[1].getText()+":"+caja[2].getText(),0);
